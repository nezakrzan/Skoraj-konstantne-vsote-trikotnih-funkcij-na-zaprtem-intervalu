...
V začetku poročila sledi podroben opis problema ter ugotovitve glede njegovega reševanja. V nadaljevanu sledijo komentrji na kodo, predstavitev rezultatov in \green{generiranje programa}.
...
\begin{itemize}
	...
	\item[{[2]}] Konzultacije z asistentom Janošom Vidalijem in s profesorjem Sergiom Cabellom.
\end{itemize}
